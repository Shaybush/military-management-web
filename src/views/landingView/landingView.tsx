...
const LandingView: FC = () => {
	...
	const getUserDetailsFromAccessToken = (): Promise<IUserDataModel> => {
		return axios.get(`${import.meta.env.VITE_GOOGLE_AUTH_URL}/oauth2/v1/userinfo?access_token=${user?.access_token}`, {
			headers: {
	...
	const setUserDetailsInLocalStorage = (userDetails: IUserDataModel['data']): void =>
